...
import { getEffectiveDates, computeNights, getStatutLabel } from "@/features/offres/utils";
...
// ---------------------------------------------------------------------------
// Field explorer — distribution of any categorical field, per year
// ---------------------------------------------------------------------------
...
export const ANALYZABLE_FIELDS: AnalyzableField[] = [
  ...
  { key: "statut", label: "Statut", accessor: (o) => getStatutLabel(o.statut) },
  {
