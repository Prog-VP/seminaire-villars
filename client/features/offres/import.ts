...
export function downloadImportTemplate() {
  ...
  const exampleRows: Record<string, string>[] = [
    {
      ...
      "Station demandée": "Villars, Diablerets, Leysin",
    ...
    },
    {
      ...
      "Chambres doubles": "45",
      "Chambres autres": "",
      "Type de séjour": "Congrès",
      "Catégorie hôtel": "4*, 5*",
      "Catégorie hôtel autre": "",
      "Station demandée": "Villars, Gryon",
      "Transmis par": "SCIB EN",
      "Traité par": "CL",
      "Statut": "Confirmé",
      "Activité uniquement": "Non",
      "Séminaire": "Oui",
      ...
      "Contact dans Brevo": "Oui",
      "N° offre": "2026-042",
      "Notes / Commentaires": "Congrès annuel récurrent. Contact VIP.",
    },
    {
  ...
  const instructions = [
    ...
    ["Pays", "Code ISO ou texte", "CH, FR, DE, GB", ""],
    ["Langue", "Texte", "Français, Anglais, Allemand", "Détermine la langue du formulaire hôtelier"],
    ["Date option du / au", "dd.mm.yyyy séparées par \" | \"", "15.06.2026 | 22.06.2026 | 01.07.2026", "Chaque paire du/au crée une option de date. Le nombre de dates du et au doit correspondre."],
    ...
    ["Catégorie hôtel", "Valeurs séparées par \",\"", "3*, 4*", "Permet de chercher dans plusieurs catégories. Valeurs possibles : 3*, 4*, 5*"],
    ["Catégorie hôtel autre", "Texte libre", "Chalet de groupe", "Catégorie hors étoiles"],
    ["Station demandée", "Valeurs séparées par \",\"", "Villars, Diablerets, Leysin", "Permet de demander dans plusieurs stations"],
